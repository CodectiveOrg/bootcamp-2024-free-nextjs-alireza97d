...
type ConvertListToObject = (list: (ListItems | string)[], searchParams: SearchParams) => ResultObject;


const convertListToObject: ConvertListToObject = (list, searchParams): ResultObject => {
